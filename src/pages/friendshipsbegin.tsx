    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="container py-8">
        ...
        <p className="text-center text-sm md:text-base text-gray-500 max-w-sm md:max-w-2xl mx-auto mt-2 px-3">
          ...
          bonus pack cards. There are three bonus packs in each starter deck box. Starter deck boxes will 
          only appear in personal ISO due to their abundance and will not be markable for trade. Bonus packs
          will appear in public and personal ISO and be tradeable.
        </p>
