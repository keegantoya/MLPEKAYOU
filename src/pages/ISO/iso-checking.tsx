    ...
    >
      <div
        ...
        onClick={(e) => {
          ...
          const menuHeight = wishlistMode ? 170 : 300;
          const menuWidth = 300;
          const gap = 10;
          const padding = 12;
      ...
      >
        {children}
        {isWishlisted && (
          <div className="pointer-events-none absolute bottom-2 right-2 z-20 flex h-7 w-7 items-center justify-center rounded-full bg-white/90 text-sm text-pink-500 shadow-sm backdrop-blur dark:bg-black/70">
            ♥
          </div>
        )}
