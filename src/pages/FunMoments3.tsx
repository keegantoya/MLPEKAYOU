...
if (rarity === "SSR") {
  ...
  const isZoomedLandscape =
    zoomedCard &&
    (zoomedCard.includes("FM3N") ||
      zoomedCard.includes("FM3SN") ||
      zoomedCard.includes("FM3CR010") ||
      zoomedCard.includes("FM3CR011") ||
      zoomedCard.includes("FM3CR012"));
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-5 sm:gap-0 mb-8 mt-6 sm:mt-0">
          ...
          <div className="flex-1 text-center">
            ...
            <p className="mt-3 text-sm md:text-base text-[#555] max-w-2xl mx-auto leading-relaxed px-2">
              Fun Moments comes back with a higher hit rate than ever - featuring 3 hits per box. All hits are of the same rarity. You can recieve 3 UGR, 3 CR, or 3 ◇CR,
            </p>
          </div>
          ...
          >
            <div className="max-h-[85vh] overflow-y-auto p-6 sm:p-8">
              ...
              <h2 className="text-2xl sm:text-3xl font-bold text-[#5a3e84] text-center mb-8">
                Fun Moments — Third Edition Products
              </h2>

              <div className="grid grid-cols-1 md:grid-cols-[220px_1fr_auto] gap-4 sm:gap-6 items-center text-center md:text-left">
                <img
                  src={funMomentsThreeBox}
                  alt="Fun Moments Third Edition Booster Box"
                  className="w-full max-w-[220px] mx-auto rounded-xl"
                />

                <div className="text-left">
                  <p className="text-gray-500 leading-relaxed">
                    This Fun Moments box comes with 20 packs per box, 7 cards per pack.
                    3/20 packs will contain a hit.
                  </p>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-[220px_1fr_auto] gap-4 sm:gap-6 items-center text-center md:text-left">
                <img
                  src={funMomentsThreePack}
                  alt="Fun Moments Third Edition Booster Pack"
                  className="w-full max-w-[220px] mx-auto rounded-xl"
                />

                <div className="text-left">
                  <p className="text-gray-500 leading-relaxed">
                    Individual booster packs have not been available for sale.
                  </p>
                </div>
