      ...
      <div className="relative mx-auto max-w-[1800px] px-3 py-3 sm:px-6 sm:py-6">
        <header className="mb-4 border border-white/[0.08] bg-[#080b0b] shadow-[0_18px_55px_rgba(0,0,0,.5)]">
          <div className="flex items-center justify-between border-b border-white/[0.06] bg-[#050707] px-3 py-2">
            ...
            <span className="font-mono text-[8px] uppercase tracking-[0.24em] text-zinc-400">PR / ASSET NODE 09</span>
          </div>
          ...
          <aside className="xl:sticky xl:top-4 xl:self-start">
            <div className="overflow-hidden border border-white/[0.09] bg-[#080b0b] shadow-[0_20px_55px_rgba(0,0,0,.5)]">
              ...
              <div className="grid grid-cols-2 gap-px border-b border-white/[0.07] bg-white/[0.06]">
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">CCG</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-[#FFD54A]">{ccgCards.length}</div></div>
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">TCG</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-white">{tcgCards.length}</div></div>
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">COLLECTED</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-emerald-400">{Object.values(flipped).filter(Boolean).length}</div></div>
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">REMAINING</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-zinc-300">{30 - Object.values(flipped).filter(Boolean).length}</div></div>
              </div>

              <div className="border-b border-white/[0.07] p-4 sm:p-5">
                <div className="mb-3 flex items-center justify-between">
                  <span className="font-mono text-[8px] font-bold uppercase tracking-[0.28em] text-zinc-300">PROMO SELECTOR</span>
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="space-y-3">
                  <div className="border-l border-[#FFD54A]/25 pl-3">
                    <div className="font-mono text-[8px] uppercase tracking-[0.2em] text-zinc-400">PRODUCT</div>
                  ...
                  <div className="border-l border-white/[0.08] pl-3">
                    <div className="font-mono text-[8px] uppercase tracking-[0.2em] text-zinc-400">FORMAT</div>
            ...
            <div className="space-y-8">
              <section id="ccg-promos" className="relative scroll-mt-5">
                ...
                <div className={ccgHidden ? "pointer-events-none select-none blur-sm" : ""}>
                  <div className="relative overflow-hidden border border-white/[0.08] bg-[#080b0b] p-4 shadow-[0_18px_45px_rgba(0,0,0,.42)] sm:p-5 lg:p-6">
                    ...
                    <div className="mb-4 flex items-end justify-between border-b border-white/[0.07] pb-3">
                      <div>
                        <div className="mb-2 flex items-center gap-2"><span className="font-mono text-[8px] font-bold uppercase tracking-[0.25em] text-zinc-400">NODE 01</span><span className="h-px w-8 bg-[#FFD54A]/25" /><span className="font-mono text-[8px] uppercase tracking-[0.18em] text-[#FFD54A]/85">CCG ACTIVE</span></div>
                        ...
                        <p className="mt-2 font-mono text-[8px] uppercase tracking-[0.2em] text-zinc-400">{ccgCards.length} ASSETS</p>
                      </div>
                      <div className="font-['Oxanium'] text-3xl font-black text-[#FFD54A]/25 sm:text-5xl">01</div>
                    </div>

                    <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-4 2xl:grid-cols-4">
                      {ccgCards.map((number) => {
                        const key = `PR-${number}`;
                        const owned = flipped[key];
                        return (
                          <div key={key} className="group relative aspect-[5/7] cursor-pointer overflow-hidden rounded-md border border-white/[0.08] bg-[#050707] shadow-[0_12px_30px_rgba(0,0,0,.48)] transition-all duration-200 md:hover:z-20 md:hover:-translate-y-2 md:hover:border-[#FFD54A]/45 md:hover:shadow-[0_22px_48px_rgba(0,0,0,.65)]" onClick={() => toggleFlip(key)}>
                            <div className={`relative h-full w-full transform-style-preserve-3d transition-all duration-200 ${hoverEffects ? "md:group-hover:rotate-1 md:group-hover:scale-[1.05]" : ""} ${owned && !viewMode ? "rotate-y-180" : ""}`}>
                            ...
                            <div className="pointer-events-none absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/65 to-transparent px-2 pb-2 pt-7">
                              <div className="font-mono text-[6px] font-bold uppercase tracking-[0.16em] text-white/70">{getPromoDisplayCode(key)}</div>
                            </div>
                    ...
                    <div className="mt-3 flex items-center justify-between border-t border-white/[0.05] pt-2">
                      <span className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">CCG / PROMO NODE</span>
                      <span className="font-mono text-[8px] uppercase tracking-[0.18em] text-zinc-400">{ccgCards.length} CARD SLOTS</span>
                    </div>
                  </div>
                </div>
              </section>
              ...
              <section id="tcg-promos" className="relative scroll-mt-5">
                ...
                <div className={tcgHidden ? "pointer-events-none select-none blur-sm" : ""}>
                  <div className="relative overflow-hidden border border-white/[0.08] bg-[#080b0b] p-4 shadow-[0_18px_45px_rgba(0,0,0,.42)] sm:p-5 lg:p-6">
                    ...
                    <div className="mb-4 flex items-end justify-between border-b border-white/[0.07] pb-3">
                      <div>
                        <div className="mb-2 flex items-center gap-2"><span className="font-mono text-[8px] font-bold uppercase tracking-[0.25em] text-zinc-400">NODE 02</span><span className="h-px w-8 bg-[#FFD54A]/25" /><span className="font-mono text-[8px] uppercase tracking-[0.18em] text-[#FFD54A]/85">TCG ACTIVE</span></div>
                        ...
                        <p className="mt-2 font-mono text-[8px] uppercase tracking-[0.2em] text-zinc-400">{tcgCards.length} ASSETS</p>
                      </div>
                    ...
                    <div className="mt-3 flex items-center justify-between border-t border-white/[0.05] pt-2">
                      <span className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">TCG / PROMO NODE</span>
                      <span className="font-mono text-[8px] uppercase tracking-[0.18em] text-zinc-400">{tcgCards.length} CARD SLOTS</span>
                    </div>
                  </div>
                </div>
              </section>
          ...
          <div className="relative flex max-h-[84vh] w-[min(72vw,320px)] flex-col sm:w-[280px]" onClick={(e) => e.stopPropagation()}>
            <div className="relative mb-2 flex h-10 shrink-0 items-center justify-between overflow-hidden border border-[#FFD54A]/25 bg-[#070a0a] px-3 shadow-[0_10px_30px_rgba(0,0,0,.5)]">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="font-mono text-[8px] font-black uppercase tracking-[0.25em] text-[#FFD54A]">CARD INSPECTION</div>
                  <div className="font-mono text-[8px] uppercase tracking-[0.18em] text-zinc-400">FRONT / BACK SYSTEM</div>
                </div>
              </div>
