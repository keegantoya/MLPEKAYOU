      ...
      <div className="relative mx-auto max-w-[1800px] px-3 py-3 sm:px-6 sm:py-6">
        <header className="mb-4 border border-white/[0.08] bg-[#080b0b] shadow-[0_18px_55px_rgba(0,0,0,.5)]">
          <div className="flex items-center justify-between border-b border-white/[0.06] bg-[#050707] px-3 py-2">
            ...
            <span className="font-mono text-[6px] uppercase tracking-[0.24em] text-zinc-700">R2 / ASSET NODE 06</span>
          </div>
          ...
          <aside className="xl:sticky xl:top-4 xl:self-start">
            <div className="overflow-hidden border border-white/[0.09] bg-[#080b0b] shadow-[0_20px_55px_rgba(0,0,0,.5)]">
              ...
              <div className="grid grid-cols-2 gap-px border-b border-white/[0.07] bg-white/[0.06]">
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[5px] uppercase tracking-[0.22em] text-zinc-700">ASSETS</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-[#FFD54A]">170</div></div>
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[5px] uppercase tracking-[0.22em] text-zinc-700">TIERS</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-white">11</div></div>
                ...
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[5px] uppercase tracking-[0.22em] text-zinc-700">REMAINING</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-zinc-300">{170 - cards.filter((card) => flipped[`${card.rarity}-${card.number}`]).length}</div></div>
              </div>
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="space-y-3">
                  ...
                  <div className="border-l border-white/[0.08] pl-3">
                    <div className="font-mono text-[5px] uppercase tracking-[0.2em] text-zinc-700">RELEASE</div>
                ...
                .map(([rarity, count], index) => (
                  <section key={rarity} id={`rarity-${rarity}`} className="relative overflow-hidden border border-white/[0.08] bg-[#080b0b] p-3 shadow-[0_18px_45px_rgba(0,0,0,.42)] sm:p-4">
                      ...
                      {cards.filter((card) => card.rarity === rarity).map((card) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {owned && !viewMode && (
                              <div className="pointer-events-none absolute left-2 top-2 border border-emerald-400/30 bg-[#07100d]/85 px-1.5 py-1 font-mono text-[5px] font-bold uppercase tracking-[0.14em] text-emerald-300">OWNED</div>
                            )}
                          </div>
                        );
                      })}
                    ...
                    <div className="mt-3 flex items-center justify-between border-t border-white/[0.05] pt-2">
                      <span className="font-mono text-[5px] uppercase tracking-[0.22em] text-zinc-700">R2 / RARITY NODE</span>
