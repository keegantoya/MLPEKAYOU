...
if (rarity === "R") {
  ...
  if (rarity === "XR") {
    return number <= 6
      ? "/card-backs/rainbow-two/R2XRBACK1.webp"
      : "/card-backs/rainbow-two/R2XRBACK2.webp";
  }
      ...
      <div className="relative mx-auto max-w-[1800px] px-3 py-3 sm:px-6 sm:py-6">
        <header className="mb-4 border border-white/[0.08] bg-[#080b0b] shadow-[0_18px_55px_rgba(0,0,0,.5)]">
          <div className="flex items-center justify-between border-b border-white/[0.06] bg-[#050707] px-3 py-2">
            ...
            <span className="font-mono text-[8px] uppercase tracking-[0.24em] text-zinc-400">R2 / ASSET NODE 06</span>
          </div>
        ...
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-[330px_minmax(0,1fr)]">
            ...
            <div className="overflow-hidden border border-white/[0.09] bg-[#080b0b] shadow-[0_20px_55px_rgba(0,0,0,.5)]">
              <div className="border-b border-white/[0.07] bg-[#050707] px-4 py-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-[5px] uppercase tracking-[0.2em] text-[#FFD54A]/60">R2</span>
                </div>
              </div>
              ...
              <div className="relative border-b border-white/[0.07] p-4 sm:p-5">
                ...
                <h1 className="mt-3 font-['Oxanium'] text-3xl font-black uppercase leading-[0.92] tracking-tight text-white sm:text-4xl">
                  Rainbow Edition
                  <span className="block text-[#FFD54A]">Series Two</span>
                </h1>
              ...
              <div className="grid grid-cols-2 gap-px border-b border-white/[0.07] bg-white/[0.06]">
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">ASSETS</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-[#FFD54A]">170</div></div>
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">TIERS</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-white">11</div></div>
                ...
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">REMAINING</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-zinc-300">{170 - cards.filter((card) => flipped[`${card.rarity}-${card.number}`]).length}</div></div>
              </div>
              ...
              <div className="border-b border-white/[0.07] p-4 sm:p-5">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <span className="font-mono text-[5px] uppercase tracking-[0.18em] text-[#FFD54A]/50">11 NODES</span>
                </div>
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="space-y-3">
                  <div className="border-l border-[#FFD54A]/25 pl-3">
                    ...
                    <div className="mt-1 text-xs font-bold uppercase text-zinc-200">Rainbow Two</div>
                  </div>
                  <div className="border-l border-white/[0.08] pl-3">
                    <div className="font-mono text-[8px] uppercase tracking-[0.2em] text-zinc-400">RELEASE</div>
                    <div className="mt-1 text-xs font-bold uppercase text-zinc-400">—</div>
                  </div>
                  <div className="border-l border-white/[0.08] pl-3">
          ...
          <main className="min-w-0">
            <div className="mb-4 flex items-center justify-between border border-white/[0.08] bg-[#080b0b] px-4 py-3">
              <div>
                <div className="font-mono text-[5px] font-bold uppercase tracking-[0.3em] text-zinc-700">ASSET MATRIX</div>
                <div className="mt-1 font-['Oxanium'] text-sm font-black uppercase tracking-[0.08em] text-white">Collection Cards</div>
              </div>
                ...
                .map(([rarity, count], index) => (
                  <section key={rarity} id={`rarity-${rarity}`} className="relative overflow-hidden border border-white/[0.08] bg-[#080b0b] p-3 shadow-[0_18px_45px_rgba(0,0,0,.42)] sm:p-4">
                      ...
                      {cards.filter((card) => card.rarity === rarity).map((card) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            {owned && !viewMode && (
                              <div className="pointer-events-none absolute left-2 top-2 border border-emerald-400/30 bg-[#07100d]/85 px-1.5 py-1 font-mono text-[8px] font-bold uppercase tracking-[0.14em] text-emerald-200">OWNED</div>
                            )}
                          </div>
                        );
                      })}
                    ...
                    <div className="mt-3 flex items-center justify-between border-t border-white/[0.05] pt-2">
                      <span className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">R2 / RARITY NODE</span>
