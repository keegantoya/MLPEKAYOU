      ...
      {cards
        ...
        .map(card => {
          ...
          return (
            <div
              key={key}
              className="group aspect-[5/7] cursor-pointer perspective"
...
className={`relative w-full h-full transform-style-preserve-3d transition-all duration-200
  ${
    hoverEffects
      ? "md:hover:-translate-y-2 md:hover:scale-[1.04] md:hover:rotate-1 md:hover:shadow-2xl"
      : ""
  }
