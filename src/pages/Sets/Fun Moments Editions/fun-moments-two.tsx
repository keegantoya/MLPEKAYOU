            ...
            <div className="overflow-hidden border border-white/[0.09] bg-[#080b0b] shadow-[0_20px_55px_rgba(0,0,0,.5)]">
              <div className="border-b border-white/[0.07] bg-[#050707] px-4 py-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-[5px] uppercase tracking-[0.2em] text-[#FFD54A]/60">FM2</span>
                </div>
              </div>
              ...
              <div className="relative border-b border-white/[0.07] p-4 sm:p-5">
                ...
                <h1 className="mt-3 font-['Oxanium'] text-3xl font-black uppercase leading-[0.92] tracking-tight text-white sm:text-4xl">
                  Fun Moments
                  <span className="block text-[#FFD54A]">Edition Two</span>
                </h1>
              ...
              <div className="grid grid-cols-2 gap-px border-b border-white/[0.07] bg-white/[0.06]">
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[5px] uppercase tracking-[0.22em] text-zinc-700">ASSETS</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-[#FFD54A]">136</div></div>
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[5px] uppercase tracking-[0.22em] text-zinc-700">TIERS</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-white">08</div></div>
                ...
                <div className="bg-[#070a0a] p-4"><div className="font-mono text-[5px] uppercase tracking-[0.22em] text-zinc-700">REMAINING</div><div className="mt-1 font-['Oxanium'] text-2xl font-black text-zinc-300">{136 - cards.filter((card) => flipped[`${card.rarity}-${card.number}`]).length}</div></div>
              </div>
              ...
              <div className="border-b border-white/[0.07] p-4 sm:p-5">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <span className="font-mono text-[5px] uppercase tracking-[0.18em] text-[#FFD54A]/50">08 NODES</span>
                </div>
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="space-y-3">
                  <div className="border-l border-[#FFD54A]/25 pl-3"><div className="font-mono text-[5px] uppercase tracking-[0.2em] text-zinc-700">PRODUCT</div><div className="mt-1 text-xs font-bold uppercase text-zinc-200">Fun Moments Two</div></div>
                  <div className="border-l border-white/[0.08] pl-3"><div className="font-mono text-[5px] uppercase tracking-[0.2em] text-zinc-700">RELEASE</div><div className="mt-1 text-xs font-bold uppercase text-zinc-400">January 2026</div></div>
                ...
                .map(([rarity, count], index) => (
                  <section key={rarity} id={`rarity-${rarity}`} className="relative overflow-hidden border border-white/[0.08] bg-[#080b0b] p-3 shadow-[0_18px_45px_rgba(0,0,0,.42)] sm:p-4">
                        ...
                        return (
                          ...
                          >
                            <div className={`relative h-full w-full transform-style-preserve-3d transition-all duration-200 ${hoverEffects ? "md:group-hover:rotate-1 md:group-hover:scale-[1.035]" : ""} ${owned && !viewMode ? "rotate-y-180" : ""}`}>
                              <img src={`/cards/${set.folder}/${set.prefix}${card.rarity}${String(card.number).padStart(3, "0")}.webp`} className="absolute inset-0 h-full w-full scale-[1.10] rounded-md object-cover object-center backface-hidden" alt="" />
                              <img src={getCardBack(card.rarity, card.number)} className="absolute inset-0 h-full w-full scale-[1.10] rounded-md object-cover object-center rotate-y-180 backface-hidden" alt="" />
                            </div>
                    ...
                    <div className="mt-3 flex items-center justify-between border-t border-white/[0.05] pt-2">
                      <span className="font-mono text-[5px] uppercase tracking-[0.22em] text-zinc-700">FM2 / RARITY NODE</span>
              ...
              <div className="relative mx-auto w-full overflow-hidden rounded-md border border-[#FFD54A]/30 bg-[#050707] shadow-[0_22px_60px_rgba(0,0,0,.85)]" onClick={() => setZoomedCardFlipped(!zoomedCardFlipped)}>
                <div className="relative aspect-[5/7] w-full max-h-[66vh] overflow-hidden rounded-md">
                  <div className={`absolute inset-0 transform-style-preserve-3d transition-transform duration-500 ${zoomedCardFlipped ? "rotate-y-180" : ""}`}>
                    <img src={zoomedCard} className="absolute inset-0 h-full w-full scale-[1.10] rounded-md object-cover object-center backface-hidden" alt="" />
                    <img src={zoomedCardBack || ""} className="absolute inset-0 h-full w-full scale-[1.10] rounded-md object-cover object-center backface-hidden" style={{ transform: "rotateY(180deg)" }} alt="" />
                  </div>
                </div>
              </div>
            </TiltCard>
