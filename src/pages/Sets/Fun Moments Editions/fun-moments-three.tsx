                ...
                <div className="grid grid-cols-2 gap-1.5">
                  {Object.keys(set.rarities).map((rarity) => (
                    ...
                    >
                      ...
                      {rarity === "SN" ? "◇N" : rarity === "SCR" ? "◇CR" : rarity}
                    </button>
                  ))}
                </div>
              </div>
          ...
          <main className="min-w-0">
            <div className="mb-4 flex items-center justify-between border border-white/[0.08] bg-[#080b0b] px-4 py-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[6px] font-bold uppercase tracking-[0.2em] text-emerald-400/70">LIVE</span>
              </div>
            </div>
                ...
                .map(([rarity, count], index) => (
                  ...
                  >
                    ...
                    <div className="mb-4 flex items-end justify-between border-b border-white/[0.07] pb-3">
                      <div>
                        <div className="mb-2 flex items-center gap-2">
                          ...
                          <span className="font-mono text-[5px] uppercase tracking-[0.18em] text-[#FFD54A]/60">ACTIVE</span>
                        </div>
                    ...
                    <div className="mt-3 flex items-center justify-between border-t border-white/[0.05] pt-2">
                      <span className="font-mono text-[5px] uppercase tracking-[0.22em] text-zinc-700">FM3 / RARITY NODE</span>
