            ...
            <div className="overflow-hidden border border-white/[0.09] bg-[#080b0b] shadow-[0_20px_55px_rgba(0,0,0,.5)]">
              <div className="border-b border-white/[0.07] bg-[#050707] px-4 py-3">
                <div className="flex items-center justify-between">
                  ...
                  <span className="font-mono text-[5px] uppercase tracking-[0.2em] text-[#FFD54A]/60">FM3</span>
                </div>
              </div>
              ...
              <div className="relative border-b border-white/[0.07] p-4 sm:p-5">
                ...
                <h1 className="mt-3 font-['Oxanium'] text-3xl font-black uppercase leading-[0.92] tracking-tight text-white sm:text-4xl">
                  Fun Moments
                  <span className="block text-[#FFD54A]">Edition Three</span>
                </h1>
              ...
              <div className="grid grid-cols-2 gap-px border-b border-white/[0.07] bg-white/[0.06]">
                <div className="bg-[#070a0a] p-4">
                  ...
                  <div className="mt-1 font-['Oxanium'] text-2xl font-black text-[#FFD54A]">148</div>
                </div>
                <div className="bg-[#070a0a] p-4">
                ...
                <div className="bg-[#070a0a] p-4">
                  ...
                  <div className="mt-1 font-['Oxanium'] text-2xl font-black text-zinc-300">
                    {148 - cards.filter((card) => flipped[`${card.rarity}-${card.number}`]).length}
                  </div>
                </div>
              </div>
              ...
              <div className="border-b border-white/[0.07] p-4 sm:p-5">
                <div className="mb-3 flex items-center justify-between">
                  ...
                  <span className="font-mono text-[5px] uppercase tracking-[0.18em] text-[#FFD54A]/50">09 NODES</span>
                </div>
                    ...
                    <button
                      ...
                      className={`border px-2 py-2 text-left font-mono text-[7px] font-bold uppercase tracking-[0.1em] transition ${
                        isRarityComplete(rarity)
                          ? "border-[#FFD54A]/60 bg-[#FFD54A]/10 text-[#FFD54A] shadow-[0_0_16px_rgba(255,212,74,.08)]"
              ...
              <div className="p-4 sm:p-5">
                ...
                <div className="space-y-3">
                  <div className="border-l border-[#FFD54A]/25 pl-3">
                    ...
                    <div className="mt-1 text-xs font-bold uppercase text-zinc-200">Fun Moments Three</div>
                  </div>
                  <div className="border-l border-white/[0.08] pl-3">
                    ...
                    <div className="mt-1 text-xs font-bold uppercase text-zinc-400">March 2026</div>
                  </div>
                  <div className="border-l border-white/[0.08] pl-3">
          ...
          <main className="min-w-0">
            <div className="mb-4 flex items-center justify-between border border-white/[0.08] bg-[#080b0b] px-4 py-3">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="font-mono text-[8px] font-bold uppercase tracking-[0.2em] text-emerald-300/95">LIVE</span>
              </div>
            </div>
                ...
                .map(([rarity, count], index) => (
                  ...
                  >
                    ...
                    <div className="mb-4 flex items-end justify-between border-b border-white/[0.07] pb-3">
                      <div>
                        <div className="mb-2 flex items-center gap-2">
                          ...
                          <span className="font-mono text-[8px] uppercase tracking-[0.18em] text-[#FFD54A]/85">ACTIVE</span>
                        </div>
                      ...
                      {cards
                        ...
                        .map((card) => {
                          ...
                          return (
                            ...
                            >
                              <div
                                className={`relative h-full w-full transform-style-preserve-3d transition-all duration-200 ${
                                  hoverEffects
                                    ? "md:group-hover:rotate-1 md:group-hover:scale-[1.035]"
                                    : ""
                                } ${owned && !viewMode ? "rotate-y-180" : ""}`}
                              >
                                <img
                                  src={`/cards/${set.folder}/${set.prefix}${card.rarity}${String(card.number).padStart(3, "0")}.webp`}
                                  className="absolute inset-0 h-full w-full scale-[1.10] rounded-md object-cover object-center backface-hidden"
                                  alt=""
                                />

                                <img
                                  src={getCardBack(card.rarity, card.number)}
                                  className="absolute inset-0 h-full w-full scale-[1.10] rounded-md object-cover object-center rotate-y-180 backface-hidden"
                                  alt=""
                                />
                              </div>
                    ...
                    <div className="mt-3 flex items-center justify-between border-t border-white/[0.05] pt-2">
                      <span className="font-mono text-[8px] uppercase tracking-[0.22em] text-zinc-400">FM3 / RARITY NODE</span>
