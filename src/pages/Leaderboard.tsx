...
return (
  ...
  return (
    ...
    >
      ...
      {/* Main */}
      <div className="relative z-10 mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8 pt-10 pb-24">
        ...
        <header className="text-center mb-14">
          ...
          <p className="mx-auto mt-5 max-w-2xl px-4 text-[10px] sm:text-xs leading-relaxed text-[#a3a3a3]">
            The leaderboard is currently under construction
            in order to offload much of the website's
            workload. Only North American collectors with a
            verified Discord profile who are present in the
            MLPEKayou Discord server are eligible.
          </p>
        </header>
        ...
        {loading ? (
          ...
          <>
            ...
            {/* Divider */}
            <div className="my-20 h-px bg-gradient-to-r from-transparent via-[#3a3a3a] to-transparent" />
